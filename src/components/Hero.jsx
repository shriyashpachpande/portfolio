...
const Hero = () => {
  ...
  <ComputersCanvas />
      ...
      {/* 🖼️ Responsive Body Image */}
      {/* ✅ Large Screens – Bottom Right */}
      <div className="absolute bottom-[40px] right-[40px] z-10 hidden sm:block">
        <img
          src={myBodyImage}
          alt="Shriyash Body"
          className="w-[450px] h-[650px] object-contain rounded-2xl shadow-[0_10px_20px_rgba(255,255,255,0.15)] hover:scale-105 transition-all duration-500 ease-in-out"
        />
      </div>
